% simulate_avatar_corr.m is the matlab interface to the cvodes mex
...
% USAGE:
% ======
% [...] = simulate_avatar_corr(tout,theta)
% [...] = simulate_avatar_corr(tout,theta,kappa,data,options)
% [status,tout,x,y,sx,sy] = simulate_avatar_corr(...)
%
% INPUTS:
% =======
...
function varargout = simulate_avatar_corr(varargin)
...
if(max(options_ami.sens_ind)>32)
...
sol = ami_avatar_corr(tout,theta(1:32),kappa(1:14),options_ami,plist,xscale,init,data);
if(nargout>1)
