function [model] = avatar_syms_corr()
...
syms Cpvc Rpu Rpv Lpv Rtot Ctot ELCo Caa Emax_LA Emax_LV Emin_LA Emin_LV Lao Lav Lmv Ppu Rao Rmv k_diast_LA k_diast_LV k_syst_LA k_syst_LV m1_LA m1_LV m2_LA m2_LV onset_LA onset_LV  mvCorr avCorr aaCorr pvCorr
% create parameter vector 
model.sym.p = [Cpvc Rpu Rpv Lpv Rtot Ctot ELCo Caa Emax_LA Emax_LV Emin_LA Emin_LV Lao Lav Lmv Ppu Rao Rmv k_diast_LA k_diast_LV k_syst_LA k_syst_LV m1_LA m1_LV m2_LA m2_LV onset_LA onset_LV mvCorr avCorr aaCorr pvCorr];
%%  
% CONSTANTS ( for these no sensitivities will be computed )

% create constant parameter syms
syms  tdiast Ks_LA Ks_LV  V0_LA V0_LV RLAvisc RLVvisc Raa Rpc Rpvc T rho_blood norm_factor_LA norm_factor_LV

% create constant parameter vector  
model.sym.k = [tdiast Ks_LA Ks_LV  V0_LA V0_LV RLAvisc RLVvisc Raa Rpc Rpvc T rho_blood norm_factor_LA norm_factor_LV];
...
%conversion of SBP using SBPdiff is done outside the model
