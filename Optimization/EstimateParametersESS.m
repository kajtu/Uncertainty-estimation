function [] =  EstimateParametersESS(loopNumber,dateStart,experimentNames,experimentRange,randomstart,numberOfSamples,startN)
%% Setup
...
problem.f   = 'costFunction'; % %name of cost-function
opts.iterprint = 1;
...
save(sprintf('%s%sEstimateParametersESS_testsave-%i%s-%s.mat',currentResultsFolder,filesep,loopNumber,randomstring,dateStart) ,'dateStart')
for r = 1:numRepeats
    fprintf(['-----E ' expName num2str(loopNumber) 'repetition num' num2str(r) ' of ' num2str(numRepeats) ' -----------------------\n'])
